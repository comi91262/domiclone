...
import (
	...
	cardsvr "github.com/comi91262/domilike/gen/grpc/card/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, cardEndpoints *card.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		cardServer = cardsvr.New(cardEndpoints, nil)
	}
	...
	cardpb.RegisterCardServer(srv, cardServer)
